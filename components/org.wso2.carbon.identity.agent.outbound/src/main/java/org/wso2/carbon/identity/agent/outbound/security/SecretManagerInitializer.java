...
import org.wso2.carbon.identity.agent.outbound.util.ApplicationUtils;
...
public class SecretManagerInitializer {
    ...
    private static final String SECURITY_DIR = "org/wso2/carbon/identity/agent/outbound/security";
